...
?>
	<div class="product-card-wrap-popular" >
		...
		<div class="product-photo">
				<img src="<?=$arResult['ITEM']["DETAIL_PICTURE"]["SRC"]?>" alt="" style="justify-self:center;display: block;max-height: -webkit-fill-available;">
			</div>
		...
		<div class="title-name">
			<a href="/catalog/detail?SECTION_ID=<?=$sectId?>&ELEMENT_ID=<?=$arResult['ITEM']["ID"]?>" style="align-items: center;display: grid;justify-content:flex-start;">
...
<script>
	$(document).ready(function(){
		$('.product-card-wrap-popular').hover(function(){
			$(this).find('.open-vac').css('opacity', 1);
		});

		$('.product-card-wrap-popular').on('mouseleave',function(){
